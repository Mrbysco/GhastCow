...
public class ModSetup {
	...
	public static void registerSpawnPlacements(final SpawnPlacementRegisterEvent event) {
		event.register(ModEntities.GHAST_COW.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, GhastCow::canSpawnHere, SpawnPlacementRegisterEvent.Operation.OR);
	}
